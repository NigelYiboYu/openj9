 ...
 * the z/Architecture. The vector register size is assumed to be 16 bytes.
 */
	...
	private void generateInputs() {
		...
		for (int testCaseNum = 1; testCaseNum <= NUM_TEST_CASE; ++testCaseNum) {
			...
			case 1:
				...
				break;
			case 2:
				// sub-string head not 16B aligned, and its length < VECTOR_SIZE
			...
			case 6:
				...
				break;
			case 7:
				// 1st-char-collision (1st char of sub-string appears multiple times before the
				// sub-string index)
			...
			case 10:
				...
				break;
			case 11:
				// sub-string head aligned to byte 0 of source string. Length = VECTOR_SIZEx2
				subStringByteIndex = 0;
				subStringByteLen = VECTOR_SIZE * 2;
				break;
			case 12:
			...
			case 15:
				// s2 header collision.
				// sub-string length > 6*VECTOR_SIZE long. head and tail are not aligned to
				// boundaries.
			...
			case 16:
				...
				break;
			case 17:
				// case 16. sub-string to be modified.
